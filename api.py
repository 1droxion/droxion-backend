...
# ✅ Add all Vercel deployments + droxion.com to prevent CORS issues
CORS(app, supports_credentials=True, origins=[
    "https://droxion-live-final-9z2l24qxj-suchitbhai-g-patel.vercel.app",
    ...
    try:
        response = requests.post(
            ...
            json={
                "model": "openai/gpt-4",
                "messages": [
                    {"role": "system", "content": "You're a senior software engineer. Return clean, working code with step-by-step explanation in Markdown triple-backtick format."},
...
# Add similar routes for /chat, /user-stats, etc. if used in frontend
